            ...
            <div class="row">
                ...
                <div class="col-md-7 col-lg-7 col-sm-12 col-xs-12 smt-40 xmt-40">
                    <div class="ht__product__dtl">
                        ...
                        <ul class="pro__prize">
                            <li><?php echo "S/. " . $get_product['0']['price'] ?></li>
                        </ul>
                        <p class="pro__info" style="font-size: 20px;"><?php echo $get_product['0']['short_description'] ?></p>
                    ...
                    <a class="fr__btn" href="javascript:void(0)" onclick="manage_cart('<?php echo $get_product['0']['id']?>','add')">AGREGAR AL CARRITO</a>
                </div>
            </div>
        </div>
    </div>
