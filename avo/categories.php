                        ...
                        <div class="htc__grid__top">
                            <div class="htc__select__option">
                                <select class="ht__select" onchange="sort_product_drop('<?php echo $cat_id ?>','<?php echo SITE_PATH ?>')" id="sort_product_id">
                                    <option value="" class="sort_op">Ordenar por defecto</option>
                                    <option value="price_low" <?php echo $price_low_selected ?> class="sort_op">Ordenar de menor a mayor precio</option>
                                    <option value="price_high" <?php echo $price_high_selected ?>class="sort_op">Ordenar de mayor a menor precio</option>
                                </select>
                            </div>
