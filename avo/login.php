                        ...
                        <div class="col-xs-12">
                            <div class="bradcaump__inner">
                                <nav class="bradcaump-inner">
                                  ...
                                  <span class="breadcrumb-item active">INICIAR SESIÓN/REGISTRO</span>
                                </nav>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
						...
						<div class="contact-form-wrap mt--60">
							<div class="col-xs-12">
								<div class="contact-title">
									<h2 class="title__line--6">Iniciar Sesión</h2>
								</div>
							</div>
							<div class="col-xs-12">
								<form id="login-form" method="post" style="font-family:'Poppins';">
					...
					<div class="col-md-6">
						<div class="contact-form-wrap mt--60">
							...
							<div class="col-xs-12">
								<form id="register-form" method="post" style="font-family:'Poppins';">
									<div class="single-contact-form">
										<div class="contact-box name">
											<input type="text" name="name" id="name" placeholder="Nombre y Apellidos" style="width:100%">
										</div>
									...
									<div class="contact-btn">
										<button type="button" class="fv-btn" onclick="user_register()">REGISTRAR</button>
									</div>
								</form>
