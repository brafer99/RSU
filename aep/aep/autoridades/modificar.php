...
$var_accion = (isset($_POST['accion']))?$_POST['accion']:"";
    ...
    if($var_accion=="Modificar"){
        ...
        $sentencia_sql= $conexion->prepare("UPDATE aep_autoridad SET
        ...
        if ($var_autoridad_imagen!=""){
            ...
            $sentencia_sql = $conexion->prepare("SELECT sql_autoridad_imagen FROM aep_autoridad WHERE sql_autoridad_id=:param_autoridad_id;");
            $sentencia_sql->bindParam(':param_autoridad_id',$var_autoridad_id);
            $sentencia_sql->execute();
            ...
            $sentencia_sql = $conexion->prepare("UPDATE aep_autoridad SET sql_autoridad_imagen=:param_autoridad_imagen  WHERE sql_autoridad_id=:param_autoridad_id;");
