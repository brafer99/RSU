...
switch($var_accion){
    case "Agregar":
        ...
        $sentencia_sql= $conexion->prepare("SELECT * FROM aep_usuario");
        ...
        $sentencia_sql= $conexion->prepare("INSERT INTO aep_usuario (
            sql_usuario_email,
            sql_usuario_pass,
            sql_usuario_rol_id) 
            VALUES (
    ...
    case "Modificar":
        ...
        $sentencia_sql= $conexion->prepare("UPDATE aep_usuario SET
    ...
    case "Borrar":
        ...
        $sentencia_sql = $conexion->prepare("DELETE FROM aep_usuario WHERE sql_usuario_id=:param_usuario_id;");
        $sentencia_sql->bindParam(':param_usuario_id',$var_usuario_id);
        $sentencia_sql->execute();
    ...
    case "Seleccionar":
        ...
        aep_usuario.sql_usuario_id, 
        aep_usuario.sql_usuario_email, 
        aep_usuario.sql_usuario_pass, 
        aep_usuario.sql_usuario_rol_id,
        aep_rol.sql_rol_nombre

        FROM aep_usuario
        JOIN aep_rol ON aep_usuario.sql_usuario_rol_id=aep_rol.sql_rol_id 
...
$sentencia_sql= $conexion->prepare("SELECT 
    ...
    FROM aep_usuario 
    JOIN aep_rol ON aep_usuario.sql_usuario_rol_id=aep_rol.sql_rol_id 
    ORDER BY aep_usuario.sql_usuario_id ASC;");
...
if(isset($var_usuario_rol_id_2)){
    ...
    $sentencia_sql_2= $conexion->prepare("SELECT * FROM aep_rol
    WHERE sql_rol_id NOT IN ( 
    SELECT sql_rol_id FROM aep_rol
