...
<body>
    ...
    <header id="header" class="fixed-top d-flex align-items-center">
        <div class="container d-flex align-items-center">
            ...
            <a href="aep" class="get-started-btn scrollto">Iniciar Sesión</a>
...
<section id="hero" class="d-flex align-items-center">
  ...
  <div class="container" data-aos="zoom-out" data-aos-delay="100">
    <div class="row">
      <div class="col-xl-6">
        <h1>ÁREA DE EXTENSIÓN Y PROYECCIÓN CULTURAL</h1>
...
<section id="faq" class="faq">
  <div class="container" >
    ...
    <ul class="faq-list accordion" data-aos="fade-up">
      ...
      <li>
        <a data-bs-toggle="collapse" class="collapsed" data-bs-target="#faq1">¿QUÉ ES EL AEP? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-x icon-close"></i></a>
        <div id="faq1" class="collapse" data-bs-parent=".faq-list">
          <p>
          Esta Área es la encargada de integrar el valor humanístico del arte en los miembros de la comunidad 
          universitaria y de difundir el arte y la cultura desde la universidad hacia la comunidad en general. 
          Ofrece servicios de capacitación en arte y cultura mediante los talleres artísticos diversos a los 
          miembros de la comunidad universitaria con la participación de los alumnos.
          </p>
        </div>
      </li>
      ...
      <li>
        <a data-bs-toggle="collapse" data-bs-target="#faq5" class="collapsed">¿CÓMO ESTA CONFORMADO EL AEP ?<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-x icon-close"></i></a>
      ...
      <li>
        <a data-bs-toggle="collapse" data-bs-target="#faq4" class="collapsed">¿DÓNDE SE ENCUENTRA EL AEP EN LA UNJBG?<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-x icon-close"></i></a>
