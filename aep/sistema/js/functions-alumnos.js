...
document.addEventListener('DOMContentLoaded',function(){
    ...
    formALumnos.onsubmit = function(e) {
        ...
        var facultad = document.querySelector('#facultad').value;
        var escuela = document.querySelector('#escuela').value;
        ...
        if(nombre == '' || apellido == '' || codigo == '' || edad == '' || cedula == '' || telefono == '' || email == '' || facultad == '' || escuela == '' || fechaNac == '' || observaciones == '' || status == '') {
...
function editAlumno() {
    ...
    btnEditAlumno.forEach(function(btnEditAlumno){
        ...
        $(document).on('click','.btnEditAlumno',function(){
            ...
            request.onreadystatechange = function() {
                if(request.readyState == 4 && request.status == 200) {
                    if(request.status) {
                        ...
                        document.querySelector('#facultad').value = objData.data.facultad;
                        document.querySelector('#escuela').value = objData.data.escuela;
...
function delAlumno() {
    ...
    btnDelAlumno.forEach(function(btnDelAlumno){
        ...
        $(document).on('click','.btnDelAlumno',function(){
            var idAlumno = this.getAttribute('rl');
            swal({
